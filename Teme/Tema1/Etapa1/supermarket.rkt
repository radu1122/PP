...
(define (min-tt counters)
  (if (null? counters)
      #f
      (minimum-main (cdr counters) (cons (counter-index (car counters)) (counter-tt (car counters))))))

(define (minimum-main counters min)
  (cond
    ((null? counters) min)
    ((< (counter-tt (car counters)) (cdr min))
     (minimum-main (cdr counters) (cons (counter-index (car counters)) (counter-tt (car counters)))))
    (else
     (minimum-main (cdr counters) min))))
